    ...
    <div class="contents">
        ...
        <div class="position">
            ...
            <div id="me" class="content">
                ...
                <p>2015年3月に大学を卒業し、あいち福祉医療専門学校へ進学。</p>
                    ...
                    <div class="row">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    ボーイソプラノからバスへの声変わりをきっかけに合唱にハマる。<br>
                                    逆転裁判のゲームをきっかけに法律に興味を持つ。<br>
                                    学校の職場体験で法律事務所を訪問し、刑事裁判を傍聴した。
                                </td>
                            </tr>
                            <tr class="table-success">
                                <td>
